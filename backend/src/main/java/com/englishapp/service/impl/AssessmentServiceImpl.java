...
public class AssessmentServiceImpl implements AssessmentService {
    ...
    public PracticeQuestionDetailResponse AnswerQuestionAssessment(Integer UserId, AnswerRequest answerRequest, Integer SessionId)
    {
        ...
        PracticeQuestion practiceQuestion = practiceQuestionRepository.findById(new PracticeQuestionId(SessionId, answerRequest.getQuestionId())).orElseThrow(QuestionNotFoundException::new);
