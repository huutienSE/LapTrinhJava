...
@Service
public class GeminiFlash31LiteServiceImpl implements AIService {
    ...
    public Feedback evaluateAnswer(String question, String answer) {
        ...
        GenerateContentResponse response = client.models.generateContent("gemini-3.1-flash-lite", prompt, null);
